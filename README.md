...
## How to Run the HR MCP Server on OpenShift Environment

Folliw the detailed instructions in the GitHub Repository: https://github.com/osa-ora/ocp-ai-custom-mcp-demo
